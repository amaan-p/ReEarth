...
class Header6 extends StatefulWidget{
  ...
  Header6(this.coordinates, this.news);
  @override
  State<Header6> createState()=>_Header6();
}
class _Header6 extends State<Header6>{
      ...
      child: Stack(
        children: [
          ...
          Padding(
            ...
            child: Text("Insights",style: TextStyle(color:Colors.black,fontWeight: FontWeight.w600,fontSize: 21.sp),),
          ),
