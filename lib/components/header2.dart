...
class Header2 extends StatefulWidget{
  ...
  Header2(this.coordinates, this.news);
  @override
  State<Header2> createState()=>_Header2();
}
      ...
      child: Stack(
        children: [
          ...
          Padding(
            ...
            child: Text("Book Appointment",style: TextStyle(color:Colors.black,fontWeight: FontWeight.w600,fontSize: 21.sp),),
          ),
