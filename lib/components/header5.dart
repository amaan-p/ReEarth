...
class Header5 extends StatefulWidget{
  ...
  Header5(this.coordinates, this.news);
  @override
  State<Header5> createState()=>_Header5();
}
class _Header5 extends State<Header5>{
      ...
      child: Stack(
        children: [
          ...
          Padding(
            ...
            child: Text("Community Listings",style: TextStyle(color:Colors.black,fontWeight: FontWeight.w600,fontSize: 20.sp),),
          ),
